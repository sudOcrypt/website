      ...
      <div className="relative bg-gray-800 rounded-2xl border border-white/10 p-6 w-full max-w-md shadow-2xl">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">
            {message || 'Please sign in with Discord to continue.'}
          </p>

          <button
            onClick={signInWithDiscord}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold transition-all shadow-lg shadow-[#5865F2]/25"
          >
