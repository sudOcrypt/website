...
const DISCORD_INVITE = 'https://discord.gg/rtP5YhJFRB';
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Thank you for your purchase{orderId ? ` (Order #${orderId.slice(0, 8).toUpperCase()})` : ''}.
          </p>
        </div>
        ...
        <div className="glass rounded-2xl border border-white/10 p-6 mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">Join Discord to receive your item</h2>
          </div>
          <p className="text-gray-400 text-sm mb-6">
            Our team will deliver your items in-game. Join our Discord server to coordinate delivery and get support.
          </p>
          <a
            href={DISCORD_INVITE}
            target="_blank"
